...
layui.define(['layer'], function (exports) {
    ...
    var AdminCommon = {
        ...
        /**错误msg提示 */
        adminLayErrorMsg:function (text) {
            top.layer.msg(text, {icon: 5});
        },
        /**成功 msg提示 */
        adminLaySucMsg:function (text) {
            top.layer.msg(text, {icon: 6});
        },
        /**ajax Confirm 对话框*/
        ajaxAdminConfirm: function (title, text, url,param) {
            layer.confirm(text, {
                title: title,
                resize: false,
                btn: ['确定', '取消'],
        ...
        /**弹出层*/
        adminLayOpen:function (title,url,width,height) {
        ...
        /**弹出层-tip*/
        adminLayOpenTip:function (title,url,width,height) {
